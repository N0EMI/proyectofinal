...
<head>
    ...
    <title>DROPRAX</title>
    <link rel="stylesheet" href="css/productos_cliente_no_resgistrado.css">
...
<body>
    <header>
        ...
        <div class="header-nav">
            ...
            <ul class="nav-links">
                <button onclick="mostrarCarrito()"><i class="fas fa-shopping-cart"></i> Ver Carrito</button>
            </ul>
        </div>
    </header>
                ...
                <?php if (count($productos) > 0): ?>
                    <?php foreach ($productos as $producto): ?>
                        <div class="producto-item">
                            ...
                            <br><br>
                            <button class="btn-agregar-carrito" onclick="agregarAlCarrito(<?php echo $producto['idproducto']; ?>, '<?php echo $producto['nombre']; ?>', <?php echo $producto['precio']; ?>)">Añadir al Carrito</button>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
